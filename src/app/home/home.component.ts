...
export class HomeComponent {
  ...
  currentNumber4 = '';
  currentNumbe4 = 'Tax amount: 0';
  currentNumbe5 = 'Salary including tax: 0';
  currentNumbe6 = 'Military fee: 0';
  currentNumbImage = '';
  firstOperand = null;
  operator = null;
  ...
  @ViewChild('ndfl') ndfl: ElementRef;
  ...
  public clear5(){
    this.currentNumbe4 = 'Tax amount: 0';
    this.currentNumbe5 = 'Salary including tax: 0';
    this.currentNumbe6 = 'Military fee: 0';
    this.ndfl.nativeElement.value = null;
    }
...
this.currentNumber3 = String(((this.inpSum.nativeElement.value * this.inpPercent.nativeElement.value) / 100).toFixed(2));
  ...
  public MaxWeightLift(op: number){
      ...
      else if (op > 1000 && op <= 5000) {
        this.currentNumbImage = 'url(https://inlnk.ru/meZ1Y)';
        this.currentNumber4 = 'Police car';
    }
  }
  public NDFL(){
    this.currentNumbe4 = String( 'Tax amount: ' + (this.ndfl.nativeElement.value * 0.18).toFixed(2));
    this.currentNumbe5 = String( 'Salary including tax and fee: ' + (this.ndfl.nativeElement.value - (this.ndfl.nativeElement.value * 0.18) - this.ndfl.nativeElement.value * 0.015).toFixed(2));
    this.currentNumbe6 = String( 'Military fee: ' + (this.ndfl.nativeElement.value * 0.015).toFixed(2));
  }
}
